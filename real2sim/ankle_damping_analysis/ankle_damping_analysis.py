...
def compute_joint_metrics(df, t, dt, fs, filepath, dataset, case_label, kp, kd, side, axis):
    ...
    # ── FRF-based fn and ζ (v4 methodology: csd(des, jnt), ∠H=-90°, ζ=1/(2G_fn)) ──
...
def build_summary(detail_rows):
    ...
    summary = grp.agg(agg)
    # Add risk grade
    zeta_col = "zeta_frf" if "zeta_frf" in summary.columns else "zeta_theory"
